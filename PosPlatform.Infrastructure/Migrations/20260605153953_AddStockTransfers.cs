        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceQuantityBefore = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SourceQuantityAfter = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DestinationQuantityBefore = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DestinationQuantityAfter = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StockTransferItems_Products_TargetProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransferItems_TargetProductId",
                table: "StockTransferItems",
